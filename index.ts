...
class WorldManager {
  ...
  private setupWorldLights(world: World) {
    ...
    createGlowingLight(world, -12, 8, 12, { r: 189, g: 60, b: 9 }, 3000);
    createGlowingLight(world, -12, 8, -10, { r: 189, g: 60, b: 9 }, 3000);
    createGlowingLight(world, 8, 8, 12, { r: 189, g: 60, b: 9 }, 3000);
    createGlowingLight(world, 8, 8, -10, { r: 189, g: 60, b: 9 }, 3000);
    createGlowingLight(world, 0, 8, 0, { r: 189, g: 60, b: 9 }, 3000);
